...
public class SalaActualizada extends DomainEvent {
    ...
    public SalaActualizada(SalaId salaId, EstaActiva estaActiva, Nombre nombreSala, List<Silla> sillas) {
        super("domain.reserva.SalaActualizada");
        this.salaId = salaId;
